...
export function Card(
  ...
  const defaultProps = {
    className: cn(
      "relative flex flex-col rounded-2xl border border-border/55 bg-card/48 text-card-foreground shadow-xs/5 backdrop-blur-xl backdrop-saturate-150 not-dark:bg-clip-padding before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-2xl)-1px)] before:bg-white/[0.03] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)]",
      className
    ),
    "data-slot": "card",
  };
